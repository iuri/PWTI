...
ad_proc -public category::get_mapped_categories_by_parent_id { 
    parent_id
    object_id 
} {
    Gets the list of categories mapped to an object. If tree_id is provided 
...
ad_proc -public category::get_id_with_tree_id { 
    name
    tree_id
    {locale en_US}
} {
...
ad_proc -public category::get_children_orderby_name {
    -category_id:required
} {
    Returns the category ids of the direct children of the given category
...
ad_proc -public category::get_objects { 
    ...
    if {$content_type ne ""} {
        ...
        set join_clause ", acs_objects o"
        set where_clause "and o.object_id = com.object_id and o.package_id = :package_id"        
    }
