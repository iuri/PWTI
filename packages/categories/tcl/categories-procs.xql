...
<fullquery name="category::get_children_orderby_name.get_children_ids">
      <querytext>
		select ca.category_id
		from categories ca,
		     category_translations ct
		where ca.parent_id = :category_id
		and      ct.category_id = ca.category_id
		and      ct.locale = 'en_US'
...
<fullquery name="category::get_id_with_tree_id.get_category_id">      
      <querytext>
...
<fullquery name="category::get_mapped_categories_by_parent_id.get_filtered">
        <querytext>
                SELECT category_object_map.category_id
                FROM category_object_map, categories
                WHERE object_id = :object_id 
