ad_page_contract {
    ...
    @cvs-id $Id: prefs.tcl,v 1.11 2005/03/01 00:01:26 jeffd Exp $
} {
    {return_url "."}
}
...
set page_title "[_ portal-content.Your]"
...
ad_form -name prefs -cancel_url $return_url -form {
    ...
    portal_content::get_user_prefs_flush -package_id $package_id -user_id $user_id
