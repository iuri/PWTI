...
as
    ...
    begin
        ...
        v_content_id := content_item.new(
            ...
            mime_type =>        null,             
            data =>             null,             
            package_id =>       bt_content.new.package_id
        );
...
as
    ...
    begin
        ...
        -- update the title
        update acs_objects set title = bt_content.name(bt_content_revision.new.content_id) where object_id =bt_content_revision.new.content_id;
