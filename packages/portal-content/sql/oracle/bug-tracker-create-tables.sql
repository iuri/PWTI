...
alter table bt_contents add constraint bt_content_parent_id_content_number_un unique (parent_id, content_number);
...
-- Create the bt_content object type
...
alter table bt_patch_content_map add constraint bt_patch_content_map_un unique (patch_id, content_id);
