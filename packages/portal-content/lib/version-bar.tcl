...
set current_version_id [portal_content::conn current_version_id]
set current_version_name [portal_content::conn current_version_name]
...
set user_version_id [portal_content::conn user_version_id]
set user_version_name [portal_content::conn user_version_name]
