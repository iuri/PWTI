...
<link rel="stylesheet" type="text/css" href="/resources/theme-mda/css/nead/menus.css" />
...
<link rel="stylesheet" type="text/css" href="/resources/theme-mda/css/nead/estilos.css" media="screen" />
...
<!--\[if lte IE 6\]>
	...
	<style type="text/css">
		body { behavior:url(/resources/theme-zen/js/csshover.htc); }
	</style>
<!\[endif\]-->
<!--\[if IE 6\]>
...
set random_top [expr [randomRange 8]  + 1]
