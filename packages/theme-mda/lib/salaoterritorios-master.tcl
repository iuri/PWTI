...
<link rel="stylesheet" type="text/css" href="/resources/theme-mda/css/salaoterritorios/estilos.css" media="screen" />
...
<!--\[if IE 6\]>
	<link href="/resources/theme-mda/css/salaoterritorios/estilos_ie6.css" rel="stylesheet" type="text/css" />
<!\[endif\]-->
<!--\[if IE 7\]>
	<link href="/resources/theme-mda/css/salaoterritorios/estilos_ie7.css" rel="stylesheet" type="text/css" />
<!\[endif\]-->
...
set random_top [expr [randomRange 3]  + 1]
...
set topo_menu [menus::dropdown topo $subsite_info(package_id)]
set secundario_menu [menus::dropdown secundario $subsite_info(package_id)]
