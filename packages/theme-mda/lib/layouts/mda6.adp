...
<div class="main">
	...
	<div class="center-content">
		<div class="center-content-padding getDrag">
	...
	<div class="bottom-content">
		<div class="bottom-content-padding getDrag">
			  <list name="element_ids_6">
			      <include src="@element_src@"
			        element_id="@element_ids_6:item@"
			        element_num="@element_ids_6:rownum@"
	    	    		element_first_num="@element_6_first_num@"
			        action_string="@action_string@"
			        theme_id="@theme_id@"
			        region="6"
			        portal_id="@portal_id@"
