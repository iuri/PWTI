...
set elements [list type [list label [_ file-storage.Type] \
		  ...
		  [list label [_ file-storage.Name] \
				...
				<if @contents.title@ nil>
					@contents.name@</a>
				<a href="@contents.download_url@" title="\#file-storage.Download_contents\#">Download</a>
				</if>
				<else>
				@contents.title@</a> <a href="@contents.download_url@" title="\#file-storage.Download_contents\#">Download</a><br/>
					<if @contents.name@ ne @contents.title@>
						<span style="color: \#999;">@contents.name@</span>
					</if>
				</else>
			} \
                      
                       <a @target_attr@ href="@contents.file_url@" title="\#file-storage.view_contents\#">
                       	<if @contents.title@ nil>@contents.name@
		               </a> 
		               <br> 
