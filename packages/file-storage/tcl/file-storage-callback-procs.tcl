...
ad_library {
    ...
    @cvs-id $Id: file-storage-callback-procs.tcl,v 1.6.2.1 2007/05/24 09:19:52 emmar Exp $
}
...
ad_proc -public -callback pm::project_new -impl file_storage {
	...
	set folder_id [db_string get_root_folder { select cf.folder_id from cr_folders cf, fs_folders ff where ff.folder_id = cf.folder_id and label = 'Projects' and ff.parent_id = :root_folder_id } -default ""]
