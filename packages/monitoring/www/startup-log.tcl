...
ad_page_contract {
    ...
    @cvs-id $Id: startup-log.tcl,v 1.2 2006/11/12 14:39:31 alessandrol Exp $
} {
    { errors_only_p 1 }
}
...
set dimensional_list {
    {
        errors_only_p "#monitoring.Show#:" 1 {
            { 1 "#monitoring.Errors_Only#" }
            { 0 "#monitoring.All_Events#" }
        }
    }
}

set title "#monitoring.Startup_Log_on# [ad_system_name]"
