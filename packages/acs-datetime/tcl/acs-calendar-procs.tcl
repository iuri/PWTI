...
ad_library {
    ...
    @cvs-id  $Id: acs-calendar-procs.tcl,v 1.22.2.1 2007/02/15 16:24:04 emmar Exp $
}
...
ad_proc dt_widget_month { 
    ...
    append output "
    <table class=\"table-display\" bgcolor=$master_bgcolor cellpadding=\"5\" cellspacing=\"0\" border=\"0\" width=\"100%\">
    <tr bgcolor=\"#848c73\"> $title </tr>
    <tr bgcolor=\"#848C73\" class=\"table-header\">\n"
	...
	if {$before_month_p || $after_month_p} {
	    ...
	    append output "<td bgcolor=$the_bgcolor align=\"center\" valign=top>[subst $day_number_template]&nbsp;"
	    #append output "<td class=$the_class bgcolor=$the_bgcolor align=\"center\" valign=top>[subst $day_number_template]&nbsp;"
	}
